package com.skt.flashbase.gis.test.sol.DataTimeLapse;
 ...
 */
public class DataTimeLapseEffect extends AppCompatActivity implements OnMapReadyCallback {
...
// This contains the MapView in XML and needs to be called after the account manager
        setContentView(R.layout.activity_data_time_lapse);
