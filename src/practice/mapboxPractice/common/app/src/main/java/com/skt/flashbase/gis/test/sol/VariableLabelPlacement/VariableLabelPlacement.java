package com.skt.flashbase.gis.test.sol.VariableLabelPlacement;
 ...
 */
public class VariableLabelPlacement extends AppCompatActivity {
                ...
                mapboxMap.setStyle(new Style.Builder().fromUrl(Style.LIGHT)
                        ...
                        new Style.OnStyleLoaded() {
                            ...
                            public void onStyleLoaded(@NonNull final Style style) {
                                Toast.makeText(VariableLabelPlacement.this,
