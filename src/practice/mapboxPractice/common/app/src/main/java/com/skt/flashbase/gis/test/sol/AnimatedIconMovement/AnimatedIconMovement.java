package com.skt.flashbase.gis.test.sol.AnimatedIconMovement;
 ...
 */
public class AnimatedIconMovement extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mapbox instance = Mapbox.getInstance(this, getString(R.string.mapbox_access_token));

        // This contains the MapView in XML and needs to be called after the access token is configured.
        setContentView(R.layout.activity_animated_icon_movement);
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        mapboxMap.setStyle(new Style.Builder().fromUrl(Style.LIGHT)
                        ...
                        .withImage(ICON_ID, BitmapUtils.getBitmapFromDrawable(
                                getResources().getDrawable(R.drawable.drawable_image_customize))), new Style.OnStyleLoaded() {
                    @Override
                    public void onStyleLoaded(@NonNull Style style) {
                        AnimatedIconMovement.this.style = style;
                        mapView.addOnDidFinishRenderingMapListener(AnimatedIconMovement.this);
                    }
                }
        );
    }
