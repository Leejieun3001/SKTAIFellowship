...
public class SymbolCollisionDetectionActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_symbol_collision_detection);
     ...
     */
    private void setUpCheckListener(int checkboxId, final boolean adjustTextIgnorePlacement,
                                    final boolean adjustIconIgnorePlacement) {
        final Switch switchUi = findViewById(checkboxId);
