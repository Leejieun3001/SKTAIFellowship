package com.skt.flashbase.gis.test.sol.CircleLayerClusters;
 ...
 */
public class CircleLayerClusters extends AppCompatActivity {
...
// This contains the MapView in XML and needs to be called after the access token is configured.
        setContentView(R.layout.activity_circle_layer_clusters);
            ...
            public void onMapReady(@NonNull MapboxMap map) {
                ...
                map.setStyle(Style.LIGHT, new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        Toast.makeText(CircleLayerClusters.this, R.string.zoom_map_in_and_out_instruction,
