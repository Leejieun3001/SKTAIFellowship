package com.skt.flashbase.gis.test.sol.DeviceLocation;
 ...
 * {@link CameraMode}.
 */
public class LocationCamera extends AppCompatActivity implements OnMapReadyCallback,
...
// This contains the MapView in XML and needs to be called after the access token is configured.
        setContentView(R.layout.activity_location_camera);
        ...
        if (PermissionsManager.areLocationPermissionsGranted(this)) {
            ...
            permissionsManager = new PermissionsManager(new PermissionsListener() {
                ...
                public void onExplanationNeeded(List<String> permissionsToExplain) {
                    Toast.makeText(LocationCamera.this,
                ...
                public void onPermissionResult(boolean granted) {
                    if (granted) {
                        mapView.getMapAsync(LocationCamera.this);
                    } else {
                        finish();
                    }
                }
