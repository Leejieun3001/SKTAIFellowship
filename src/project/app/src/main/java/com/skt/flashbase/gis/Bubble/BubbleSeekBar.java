package com.skt.flashbase.gis.Bubble;
...
import static com.skt.flashbase.gis.Bubble.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.skt.flashbase.gis.Bubble.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.skt.flashbase.gis.Bubble.BubbleSeekBar.TextPosition.SIDES;
import static com.skt.flashbase.gis.Bubble.BubbleUtils.dp2px;
import static com.skt.flashbase.gis.Bubble.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBubbleTextSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_bubble_text_size, sp2px(11));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isShowThumbText && !isThumbOnDragging && isTouchToSeekAnimEnd) {
            ...
            if (isFloatType || (isShowProgressInFloat && mSectionTextPosition == BOTTOM_SIDES &&
                ...
                for (int i = 0; i <= mSectionCount; i++) {
                    if ((getProgress() >= mSectionValue * i) && (getProgress() < mSectionValue * i + 1)) {
                        canvas.drawText(String.valueOf(mSectionTextArray.get(i)), mThumbCenterX, y_, mPaint);
                    }
                }
            } else {
                for (int i = 0; i <= mSectionCount; i++) {
